...
useEffect(() => {
  const fetchBarangays = async () => {
    try {
      ...
      console.log("Barangay API Response:", response.data);
      setBarangays(response.data.data);
      console.log("Set barangays:", response.data.data);
    } catch (error) {
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div>
      ...
      <Select
        ...
        onValueChange={value => onFormChange('educationalAttainment', value)}
      >
        <SelectTrigger className="w-full">
          <SelectValue placeholder="Select" />
        </SelectTrigger>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <Select
            ...
            onValueChange={value => onFormChange('relationshipToFamilyHead', value)}
          >
            <SelectTrigger className="w-full">
