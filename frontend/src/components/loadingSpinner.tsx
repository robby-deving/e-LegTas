...
/**
 * A reusable loading spinner component with customizable text and size.
 *
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-2">
      <div role="status" aria-live="polite" aria-busy="true">
        <svg
          aria-hidden="true"
          className={`animate-spin text-gray-200 dark:text-gray-700 fill-green-600 ${sizeClasses[size]}`}
          viewBox="0 0 100 101"
          fill="none"
