    ...
    try {
        ...
        const result = filtered.map(entry => {
            ...
            return {
                ...
                full_name: `${resident.first_name} ${resident.middle_name || ''} ${resident.last_name} ${resident.suffix || ''}`.trim(),
                sex: resident.sex,
                birthdate: resident.birthdate,
                barangay: resident.barangays?.name || 'Unknown',
                ...
                // Additional details from evacuee_residents
